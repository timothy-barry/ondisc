...
`gene_mat` is a gene expression matrix containing 3 genes and 4 cells. We pass this matrix to `create_odm_from_r_matrix()`, setting `file_to_write` to `paste0(temp_dir, "/gene.odm")`.
