test_that("check covariates", {
  for (i in seq(1, n_datasets)) {
    ...
    cell_covariates_list <- list(cov_odms[[i]]@cell_covariates,
                                 cov_odms_from_memory[[i]]$cell_covariates)
    for (cell_covariates in cell_covariates_list){
    ...
    feature_covariates_list <- list(cov_odms[[i]]@feature_covariates,
                                    cov_odms_from_memory[[i]]$feature_covariates)
    for (feature_covariates in feature_covariates_list){
